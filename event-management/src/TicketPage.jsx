...
const BOOKING_DATE = new Date().toLocaleDateString("en-IN", {
  day: "numeric",
  month: "long",
  year: "numeric",
});
const BOOKING_TIME = new Date().toLocaleTimeString("en-IN", {
  hour: "2-digit",
  minute: "2-digit",
});
                  ...
                  {selectedProgrammes.map((prog, idx) => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-6 h-6 bg-black text-[#C4F249] flex items-center justify-center text-xs font-bold shrink-0">
                          {idx + 1}
                        </div>
                        <div>
              ...
              <div className="space-y-1">
                ...
                <div className="border-t border-gray-200 pt-2 flex justify-between">
                  ...
                  <span className="font-bold text-black text-lg">
                    {isFree ? "₹0.00 (Free)" : `₹${totalPrice}.00`}
                  </span>
                </div>
              </div>
